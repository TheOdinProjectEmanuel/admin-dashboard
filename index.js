...
const dashboardElements = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat qui doloremque enim non praesentium a!",
    actions: {
...
function renderNavElements() {
  ...
  for (const item of navElements) {
    ...
    li.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="${CONFIG.svgWidth}" height="${CONFIG.svgHeight}" fill="currentColor" class="bi bi-${item.icon}" viewBox="0 0 18 18">
            ${item.svgPath}
        </svg>
    `;
...
function renderDashboardElements() {
  for (const item of dashboardElements) {
    ...
    <svg
        ...
        viewbox="0 0 16 16"
        class="bi bi-eye"
        onclick="handleClick('${item.actions.projectLink}')"
    >
        <path
    ...
    <svg
        ...
        viewbox="0 0 16 16"
        class="bi bi-github"
        onclick="handleClick('${item.actions.githubLink}')"
    >
        <path
